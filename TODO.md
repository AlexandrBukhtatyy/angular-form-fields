...
## TODOs
- Пересмотреть концепцию работы списка чекбоксов (сейчас id, selected - в генерации есть не решенные проблемы)
...
- ! Возможно DataProvider-директива лишняя и можно просто в компонент кидать (ComboboxDataProviderDirective)
