...
@Component({
  selector: 'aff-option-with-tooltip-value-template',
  standalone: true,
  imports: [CommonModule, TuiTooltipModule],
  templateUrl: './option-with-tooltip-value-template.component.html',
  styleUrls: ['./option-with-tooltip-value-template.component.less']
})
export class OptionWithTooltipValueTemplateComponent<T> {
